...
const cities = [
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-100  flex items-center pt-10 pb-5 px-3 justify-center  bg-black/70">
     <form className="flex bg-white rounded-xl max-w-4xl max-md:mx-2 ">
        <img src={assets.regImage} alt="registration-image" className="w-1/2 rounded-xl hidden md:block" />
        <div>
         <img src={assets.closeIcon} alt="close-icon" className="w-6 absolute top-4 right-4 h-4 cursor-pointer" />
         <p className="text-2xl font-semi-bold mt-6 px-3">Register Your Hotel</p>
         ...
         {/*phone */}
          ...
          <div className='w-full mt-4'>
            ...
            <div className='w-full mt-4 max-w-60 mr-auto' >
                <label htmlFor="city" className='font-medium text0-gray-500'> City</label>
