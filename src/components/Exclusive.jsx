...
opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300">
            ...
            <span className="absolute bottom-3 right-3 text-white"> Expires 23rd January 2026 </span>
              <button className=" w-[120px] text-[10px] absolute bottom-2 left-5 mt-2 flex items-center px-1 py-1 gap-2 bg-white rounded-2xl text-black mr-3 px-3 py-2 mt-4 sm:mt-0">
             View All Offers
